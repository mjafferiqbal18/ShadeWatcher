...
void ReduceNoise::DeleteNoise()
{
	...
	std::cout << "Before TmpFile(): " << noisy_edges.size() << std::endl;
	std::cout << "\tcollecting temporary file" << std::endl;
	TmpFile();
	std::cout << "After TmpFile(): " << noisy_edges.size() << std::endl
			  << std::endl;

	std::cout << "Before ShadowFileEdge(): " << noisy_edges.size() << std::endl;
	std::cout << "\tcollecting ShadowFileEdge" << std::endl;
	ShadowFileEdge();
	std::cout << "After ShadowFileEdge(): " << noisy_edges.size() << std::endl
			  << std::endl;

	std::cout << "Before ShadowProcEdge(): " << noisy_edges.size() << std::endl;
	std::cout << "\tcollecting ShadowProcEdge" << std::endl;
	ShadowProcEdge();
	std::cout << "After ShadowProcEdge(): " << noisy_edges.size() << std::endl
			  << std::endl;

	std::cout << "Before MissingEdge(): " << noisy_edges.size() << std::endl;
	std::cout << "\tcollecting MissingEdge" << std::endl;
	MissingEdge();
	std::cout << "After MissingEdge(): " << noisy_edges.size() << std::endl
			  << std::endl;

	std::cout << "Before Library(): " << noisy_edges.size() << std::endl;
	std::cout << "\tcollecting Library" << std::endl;
	Library();
	std::cout << "After Library(): " << noisy_edges.size() << std::endl
			  << std::endl;
